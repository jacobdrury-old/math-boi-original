...
module.exports = {
    ...
    async execute(message, args) {
        ...
        const isUserAdmin = guildMember.hasPermission('ADMINISTRATOR') || guildMember.roles.cache.has(roles.dev.Id);

        const useableCommands = commands.filter((cmd) => cmd.adminOnly == null || isUserAdmin);
